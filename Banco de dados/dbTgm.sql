...
CREATE TABLE docente_has_disponibilidade (
  docente_id_docente INTEGER UNSIGNED NOT NULL,
  disponibilidade_id_disponibilidade INTEGER UNSIGNED NOT NULL,
  PRIMARY KEY(docente_id_docente, disponibilidade_id_disponibilidade),
  INDEX docente_has_disponibilidade_FKIndex1(docente_id_docente),
  INDEX docente_has_disponibilidade_FKIndex2(disponibilidade_id_disponibilidade)
);
