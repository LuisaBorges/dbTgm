	...
	<body>		
		...
		<div class="container">
			...
			<div class="bloco-form">
				<form action="validar.php?acao=validar-cadastro" method="POST" class="espacamentoform">
					...
					<div class="input-group">
						...
						<input type="password" class="form-control" name="senha_login" id="senha_login" placeholder="Senha (Mínimo 5 caracteres)" minlength="5" maxlength="20" required>
					</div>
					<div class="input-group">
						<div class="input-group-addon"><i class="fa fa-lock" aria-hidden="true"></i></div>
