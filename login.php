	...
	<body>		
		<div class="container">
			...
			<div class="bloco-form">
				<form action="validar.php?acao=validar-login" method="POST" class="espacamentoform">
					...
					<div class="input-group">
					    ...
					    <input type="password" class="form-control" name="senha_login" id="senha_login" placeholder="Senha" minlength="5" maxlength="20" required>
					</div>
